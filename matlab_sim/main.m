...
channels_detected = find(chan_data_power_logic);
disp(['Channels located include ',num2str(channels_detected)]);
target_chan_str = input('Target channel: ','s');

target_chan = str2num(target_chan_str);
